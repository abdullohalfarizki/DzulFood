...
<div class="col-lg-9 mt-2">
    <div class="card">
        ...
        <div class="card-body">
            ...
            ?>
                ...
                <div class="modal fade" id="bayar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-fullscreen-md-down">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-6" id="exampleModalLabel"><i class="bi bi-cash-coin"></i> Pembayaran</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <!-- Tabel data Order Item Pesanan -->
                                ...
                                <!-- Akhir Tabel data Order Item Pesanan -->
                                <span class="text">Apakah Anda Yakin Ingin Melakukan Pembayaran?</span>
                                <form class="needs-validation" novalidate action="proses/proses_bayar.php" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-floating mb-3 mt-2">
                                                <input type="number" name="uang" class="form-control" id="floatingInput" placeholder="Masukan Nominal Uang" required>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Close</button>
                                        <button type="submit" name="bayar_validate" value="12345" class="btn btn-primary btn-sm">Bayar</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                                    ...
                                    <td class="">
                                        <div class="row">
                                            <div class="col d-flex">
                                                <button class="<?= (!empty($row['id_bayar'])) ? "btn btn-secondary btn-sm me-1 disabled" : "btn btn-warning btn-sm me-1"; ?>" data-bs-toggle="modal" data-bs-target="#ModalEdit<?php echo $row['id_list_order']; ?>"><i class="bi bi-pencil-square"></i></button>
                                                <button class="<?= (!empty($row['id_bayar'])) ? "btn btn-secondary btn-sm me-1 disabled" : "btn btn-danger btn-sm me-1"; ?>" data-bs-toggle="modal" data-bs-target="#ModalHapus<?php echo $row['id_list_order']; ?>"><i class="bi bi-trash"></i></button>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
            ...
            <!-- tombol -->
            <div class="mb-3">
                <button class="<?= (!empty($row['id_bayar'])) ? "btn btn-secondary btn-sm mt-2 disabled" : "btn btn-primary btn-sm mt-2"; ?>" data-bs-toggle="modal" data-bs-target="#tambahItem"><i class="bi bi-plus-circle"></i> Item</button>
                <button class="<?= (!empty($row['id_bayar'])) ? "btn btn-secondary btn-sm mt-2 disabled" : "btn btn-success btn-sm mt-2"; ?>" data-bs-toggle="modal" data-bs-target="#bayar"><i class="bi bi-cash-coin"></i> Bayar</button>
            </div>
        </div>
    </div>
</div>